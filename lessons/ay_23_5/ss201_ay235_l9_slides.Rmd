...
subtitle: "Lesson 9: Long Run Economic Growth"
...
```{r solow_complete, out.width='90%', fig.align='center'}
knitr::include_graphics("img/solow_complete.png")
```
...
Improve human capital to increase $\frac{H}{L}$
