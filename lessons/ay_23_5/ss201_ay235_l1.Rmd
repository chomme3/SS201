...
\begin{center}
    ...
    Lesson 1: Economic Methods, Models, and Gains from Exchange
\end{center}
\fancyfoot[C]{\thepage}
...
\pagebreak
# Trade
Now let me introduce you to MAJ Traeger. When it comes to the grill, this man's a straight savage! On one Sunday, he can either grill 40 steaks or smoke 10 turkeys.

1. Compared with MAJ Homme, which person has the absolute advantage in producing steaks? Turkeys? 
  \vspace{3cm}

2. Given your answer to the previous question, does it ever make sense for MAJ Traeger to trade with MAJ Homme?
  \vspace{3cm}
...
5. Without trade, MAJ Homme can produce 15 steaks and 2 turkeys and MAJ Traeger can produce 8 steaks and 8 turkeys. If they decide to trade, how much can each attain relative to these production sets? Graph both production possibility frontiers below, the production points they can produce without trade, and the production points they can attain with trade.
