...
3. Squints is now confused. His teacher told him that an elasticity was not a slope, but each answer he gave in the previous problem seemed depend on the slope of the demand curve. You being well versed in elasticities tell him to calculate the following elasticities using the graph below.
...
6. The maximum capacity of the pool is 1,800 people. The lifeguard derives the following for demand based on her experiment: $Q_d =1800 - 40P$. Calculate the point elasticity at a praice of \$10. \vspace{3cm}
...
3. What is income elasticity? \vspace{3cm}
    ...
    a. Suppose that, with an average state income of 75,000/year, consumers in the US buy 12 million baseballs. Now, suppose the average income in US jumps to 85,000/year and consumers buy 14 million baseballs. What is the income elasticity of demand for baseballs? (Use the midpoint formula) 
    \vspace{3cm}
    b. What does the sign of the income elasticity for baseballs tell us about them? Could some goods have the opposite sign of elasticity?does the sign of the income elasticity for baseballs tell us about them? Could some goods have the opposite sign of elasticity?
    \vspace{3cm}
